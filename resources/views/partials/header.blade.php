    ...
    <div class="container-x">
        <div class="flex items-center gap-4 py-3">
            ...
            <div class="ms-auto flex items-center gap-1.5">
                ...
                {{-- Cart --}}
                <a href="{{ route('cart.index') }}" data-cart-link class="relative grid h-10 w-10 place-items-center rounded-xl transition hover:bg-slate-100">
                    ...
                    <span data-cart-count class="absolute -top-1 -end-1 grid h-5 min-w-5 place-items-center rounded-full bg-accent px-1 text-[11px] font-bold text-white transition">{{ $cart->count() }}</span>
                </a>
